...
const Programs: React.FC = () => {
  // আপনার হোয়াটসঅ্যাপ নম্বর (country code সহ)
  ...
  const academicPrograms = [
    {
      ...
      accent: "bg-green-500",
      whatsappMsg: "আসসালামু আলাইকুম, আমি জুনিয়র ব্যাচ (৬ষ্ঠ-৮ম শ্রেণি) সম্পর্কে বিস্তারিত জানতে চাই।"
    },
    {
      ...
      whatsappMsg: "আসসালামু আলাইকুম, আমি এসএসসি প্রস্তুতি (৯ম-১০ম শ্রেণি) সম্পর্কে বিস্তারিত জানতে চাই।"
    },
    {
      ...
      border: "border-green-100",
      accent: "bg-green-500",
      whatsappMsg: "আসসালামু আলাইকুম, আমি আপনাদের স্পেশাল প্রোগ্রাম (মডেল টেস্ট ও ইংরেজি) সম্পর্কে জানতে চাই।"
    }
  ];

  return (
    <section id="programs" className="py-24 bg-slate-50/30">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4 max-w-2xl mx-auto font-medium">
            অভিজ্ঞ মেন্টরদের তত্ত্বাবধানে প্রতিটি শিক্ষার্থীর জন্য সাজানো হয়েছে আলাদা আলাদা স্পেশাল ব্যাচ।
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {academicPrograms.map((program, index) => (
            <div 
              key={index} 
              className={`relative overflow-hidden p-10 rounded-[45px] border-2 ${program.bg} ${program.border} transition-all duration-500 hover:shadow-2xl hover:-translate-y-4 group flex flex-col justify-between`}
            >
              {/* উপরের ডেকোরেশন */}
                ...
                <div className="space-y-4 mb-10">
                  {program.features.map((feature, fIndex) => (
                    <div key={fIndex} className="flex items-center gap-3">
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center text-white text-[10px] ${program.accent}`}>
                        ✓
                      </div>
              ...
              <a 
                ...
                className={`relative z-10 w-full text-center py-4 rounded-2xl font-bold transition-all duration-300 ${program.accent} text-white hover:opacity-90 shadow-lg shadow-black/5 active:scale-95 flex items-center justify-center gap-2`}
              >
